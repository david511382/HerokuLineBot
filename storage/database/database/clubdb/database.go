...
import (
	...
	"heroku-line-bot/storage/database/database/clubdb/activityfinished"
	"heroku-line-bot/storage/database/database/clubdb/income"
	"heroku-line-bot/storage/database/database/clubdb/logistic"
	...
	"heroku-line-bot/storage/database/database/clubdb/rentalcourt"
	"heroku-line-bot/storage/database/database/clubdb/rentalcourtdetail"
	"heroku-line-bot/storage/database/database/clubdb/rentalcourtledger"
	"heroku-line-bot/storage/database/database/clubdb/rentalcourtledgercourt"
	"heroku-line-bot/storage/database/database/clubdb/rentalcourtrefundledger"
