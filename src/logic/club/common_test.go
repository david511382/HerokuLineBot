...
func Test_calculateActivityPay(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotActivityFee, gotClubMemberFee, gotGuestFee := calculateActivityPay(tt.args.people, tt.args.ballConsume, tt.args.pricePerBall, tt.args.courtFee, tt.args.clubSubsidy)
